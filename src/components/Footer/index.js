        ...
        <div className={styles.content}>
          <div className={styles.footerLinksColumn}>
            ...
            <div className={styles.footerLinks}>
              <Link className={styles.buttonBase} to="/pdf-to-jpg">
                <div className={styles.text}>PDF to JPG</div>
              </Link>
              <Link className={styles.buttonBase} to="/jpg-to-pdf">
                <div className={styles.text}>JPG to PDF</div>
              </Link>
              <Link className={styles.buttonBase} to="/heic-to-jpg">
                <div className={styles.text}>HEIC to JPG</div>
              </Link>
              <Link className={styles.buttonBase} to="/image-to-pdf">
          ...
          <div className={styles.footerLinksColumn}>
            ...
            <div className={styles.footerLinks}>
              <Link className={styles.buttonBase} to="/mp4-to-mp3">
                <div className={styles.text}>MP4 to MP3</div>
              </Link>
              <Link className={styles.buttonBase} to="/video-to-mp3">
          ...
          <div className={styles.footerLinksColumn}>
            ...
            <div className={styles.footerLinks}>
              <Link className={styles.buttonBase} to="/video-to-gif">
              ...
              <Link className={styles.buttonBase} to="/mov-to-mp4">
          ...
          <div className={styles.footerLinksColumn}>
            ...
            <div className={styles.footerLinks}>
              ...
              <Link className={styles.buttonBase} to="/epub-to-pdf">
